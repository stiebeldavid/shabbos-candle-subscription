...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = 'shabbos-candle-subscription-bhf65.myshopify.com';
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = '25d9c3890923f0cb3c91bf73c4f5eabe';
